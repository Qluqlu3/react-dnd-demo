...
exports.Container = function () {
    {
        ...
        var renderCard_1 = function (card, index) {
            return (react_1["default"].createElement(Card_1.Card, { key: card.id, index: index, id: card.id, text: card.text, moveCard: moveCard_1 }));
        };
        return (react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("div", { style: style }, cards_1.map(function (card, i) { return renderCard_1(card, i); }))));
    }
};
